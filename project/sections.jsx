...
function EmberField({ mobile }) {
  const embers = React.useMemo(() => Array.from({ length: mobile ? 8 : 18 }, (_, i) => ({
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        fontSize: 28, color: 'var(--fg)', position: 'relative',
      }}>
    ...
    <footer style={{
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16, marginTop: 24,
          ...
          <div>© 2026 PROMVIS · MADE IN VIETNAM ★ · <a href="/origin" style={{ color: 'var(--fg-faint)', textDecoration: 'none', borderBottom: '1px dotted var(--fg-faint)' }} title="—">ORIGIN</a></div>
